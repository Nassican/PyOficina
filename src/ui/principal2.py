...
class VentanaPrincipal(QWidget):
    ...
    def buscar_codigo_producto(self, archivo_excel):
        ...
        codigo = excel.buscar_codigo_producto(categoria_texto, producto_texto, archivo_excel)

        print(f"Producto: {producto_texto}, Categoria: {categoria_texto}, Codigo: {codigo}")
